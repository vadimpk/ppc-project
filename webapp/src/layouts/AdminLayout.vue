        ...
        <nav class="sidebar bg-container p-4">
          ...
          <ul class="nav flex-column">
            <li class="h5 nav-item">
              <router-link to="/admin/appointments" class="nav-link" active-class="active">Appointments</router-link>
            </li>
            <hr class="hr"/>
            <li class="h5 nav-item">
              <router-link to="/admin/services" class="nav-link" active-class="active">Services</router-link>
            </li>
            <hr class="hr"/>
            <li class="h5 nav-item">
              <router-link to="/admin/employees" class="nav-link" active-class="active">Employees</router-link>
            </li>
            <hr class="hr"/>
            <li class="h5 nav-item">
